      ...
      <div className="border-2 rounded-2xl">
        <div className="flex items-center justify-center flex-col border-b-[3px] border-orange-500 p-6 rounded-3xl">
          <img
            ...
            alt=""
          />
          <h1 className="text-2xl font-semibold mt-3 text-[#19191ada]">John Doe</h1>
          <h1 className=" mt-1 font-medium text-[#2222248f]">Nutritionist, Punki Medical</h1>
        </div>
        <div className="p-6">
    ...
    <div className="mt-32 max-w-7xl mx-auto">
      <div className="text-center flex flex-col items-center">
        <h1 className="text-[48px] font-black text-[#302f2f]">
          <span className="text-[#e28030]">H</span>appy{" "}
          <span className="text-[#e28030]">C</span>lient{" "}
